git submodule add https://github.com/google/googletest.git engine/thirdparty/googletest
git submodule add https://github.com/syoyo/tinygltf.git engine/thirdparty/tinygltf
git submodule add https://github.com/grpc/grpc.git engine/thirdparty/grpc
