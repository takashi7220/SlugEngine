...
render_core::DrawContextPtr Application::CreateDrawContext(const Param& param) const
{
    render_core::DrawContext::SetupParam desc;
    desc.enableDebug = param.enableDebug;
    desc.apiType = render_core::GraphicsApiType::D3D12;
    return render_core::DrawContext::Create(desc);
}
...
core::WindowPtr Application::GenerateWindow(const Param& param, const render_core::DrawContextPtr& context, core::WindowManagerPtr& windowManager) const
{
    ...
    render_core::DrawContext::WindowParam windowParam;
