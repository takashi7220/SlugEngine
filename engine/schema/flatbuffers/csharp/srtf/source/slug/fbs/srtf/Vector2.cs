...
namespace slug.fbs.srtf
{
    public struct Vector2 : IFlatbufferObject
    {
        ...
        public static Offset<slug.fbs.srtf.Vector2> CreateVector2(FlatBufferBuilder builder, float X, float Y)
        {
            builder.Prep(4, 8);
            builder.PutFloat(Y);
            builder.PutFloat(X);
            return new Offset<slug.fbs.srtf.Vector2>(builder.Offset);
        }
        ...
        public static Offset<slug.fbs.srtf.Vector2> Pack(FlatBufferBuilder builder, Vector2T _o)
        {
            if (_o == null) return default(Offset<slug.fbs.srtf.Vector2>);
