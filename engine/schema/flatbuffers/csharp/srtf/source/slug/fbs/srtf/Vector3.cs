...
namespace slug.fbs.srtf
{
    public struct Vector3 : IFlatbufferObject
    {
        ...
        public static Offset<slug.fbs.srtf.Vector3> CreateVector3(FlatBufferBuilder builder, float X, float Y, float Z)
        {
            builder.Prep(4, 12);
            builder.PutFloat(Z);
            builder.PutFloat(Y);
            builder.PutFloat(X);
            return new Offset<slug.fbs.srtf.Vector3>(builder.Offset);
        }
        ...
        public static Offset<slug.fbs.srtf.Vector3> Pack(FlatBufferBuilder builder, Vector3T _o)
        {
            if (_o == null) return default(Offset<slug.fbs.srtf.Vector3>);
