...
{
public:
    FileHandlePtr Open(const FileOepnDesc& desc) override;
    ...
    virtual String ReadText(core::StringView filePath) override;
    virtual bool ReadText(core::StringView filePath, String& out) override;
    ...
    virtual bool WriteText(core::StringView filePath,const core::String& text, bool makeDir = true) override;
...
private:
    String GetCurrentDirectoryImpl();
};
}
#endif
