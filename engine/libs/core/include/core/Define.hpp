...
#else
#define SLUG_ENABLE_CPP14
#define SLUG_ENABLE_CPP17
#define SLUG_ENABLE_CPP20
#endif
...
#define SLUG_PROPERTY(...)
#define SLUG_NAMEOF(x) #x

#define SLUG_DEBUG_MODE DEBUG_MODE
#define SLUG_ENABLE_MEMORY_COUNTER SLUG_DEBUG_MODE
