...
{                                                                                                                                          \
    return engine_core::AssetType(#type);                                                                                                  \
                                                                                                                                           ...
                                                                                                                                           \
static core::TReferencePtr<engine_graphics::GraphicsAssetBase> Create(const engine_core::AssetHeader& header, render_core::RenderService& service)   \
{                                                                                                                                          \
    type* asset(new type(header, context));                                                                               \
    return core::MemoryUtility::CheckedCast<engine_graphics::GraphicsAssetBase*, type*>(asset);                                                           \
}                                                                                                                                          \
...
{
public:
    GraphicsAssetBase(const engine_core::AssetHeader& header, render_core::RenderService& service);
