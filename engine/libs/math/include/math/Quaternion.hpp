...
struct Quaternion
{
    ...
    static Quaternion FromMatrix(const Matrix4x4& mat)
    {
        ...
        if (trace > 0.0f)
        {
            float s = math::TSqrt(trace + 1.0f) * 2.0f;
            q.w = 0.25f * s;
        ...
        {
            float s = math::TSqrt(1.0f + mat.m[0] - mat.m[5] - mat.m[10]) * 2.0f;
        ...
        {
            float s = math::TSqrt(1.0f + mat.m[5] - mat.m[0] - mat.m[10]) * 2.0f;
        ...
        {
            float s = math::TSqrt(1.0f + mat.m[10] - mat.m[0] - mat.m[5]) * 2.0f;
