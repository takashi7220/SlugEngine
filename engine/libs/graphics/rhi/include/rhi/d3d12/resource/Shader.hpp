...
{
public:
    SLUG_DECLARE_SOBJECT_TYPEINFO(Shader, IShader)
...
{
public:
    SLUG_DECLARE_SOBJECT_TYPEINFO(ShaderLibrary, IShaderLibrary)
    core::TVector<char> bytecode;
...
{
public:
    SLUG_DECLARE_SOBJECT_TYPEINFO(ShaderLibraryEntry, IShader)
