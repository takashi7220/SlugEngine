...
void D3D12Raytracing::FillD3dGeometryTrianglesDesc(D3D12_RAYTRACING_GEOMETRY_TRIANGLES_DESC& outDxrTriangles, const rt::GeometryDesc& geometryDesc, D3D12_GPU_VIRTUAL_ADDRESS transform4x4)
{
    ...
    {
        outDxrTriangles.IndexBuffer = core::SObjectUtility::CheckedCast<Buffer>(triangles.indexBuffer)->gpuVirtualAddress + triangles.indexOffset;
    }
    else
    {
    ...
    {
        outDxrTriangles.VertexBuffer.StartAddress = core::SObjectUtility::CheckedCast<Buffer>(triangles.vertexBuffer)->gpuVirtualAddress + triangles.vertexOffset;
    }
    else
    {
...
void D3D12Raytracing::FillD3dAABBDesc(D3D12_RAYTRACING_GEOMETRY_AABBS_DESC& outDxrAABB, const rt::GeometryDesc& geometryDesc)
{
    ...
    if (aabbs.buffer)
    {
        outDxrAABB.AABBs.StartAddress = core::SObjectUtility::CheckedCast<Buffer>(aabbs.buffer)->gpuVirtualAddress + aabbs.offset;
    }
    else
    {
